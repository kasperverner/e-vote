...
async function putDeclineInvitation(authToken: string, team_id: string, invitation_id: string) {
  return await fetch(`${import.meta.env.VITE_API_BASE_URL}/teams/${team_id}/members/invitations/${invitation_id}/decline`,
    {
      method: "PUT",
